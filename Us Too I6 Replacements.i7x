Version 1/250905 of Us Too I6 Replacements by Andrew Schultz begins here.

"I6 replacement code to change just one bit of text"

volume to tweak end menu response
...
! Ask:      see Answer
  ...
  Miscellany: switch (n) {
        ...
        7:  "[You cannot ~undo~ any further.]";
            #Endif; ! TARGET_
        8:  "Before you can try something too outside the box, one of the lawyers says ~Boy! this is STEW, EH?~ The others agree.";
...
Us Too I6 Replacements ends here.
