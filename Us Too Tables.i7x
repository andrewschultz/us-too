...
"dope"	"ale"	--	"ail"	hom-dope-ale rule	false	false	false	false	"finding something to trade your dough pail for"	false	true	true	false	false	deli stern	pre-dope-ale rule	post-dope-ale rule	--	"You can trade for some [b]DOPE ALE[r] [once-now of pre-dope-ale rule] you've found willing traders with a bit extra."
